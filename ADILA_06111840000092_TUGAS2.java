 ...
 * @author ASUS
 */
public class TugasAsis extends javax.swing.JDialog {
    /**
     * Creates new form TugasAsis
     */
    public TugasAsis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jSoalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSoalActionPerformed
      ...
      if (soal == "Soal 2"){
          ...
          jKeterangan.setText("Masukkan a sudut derajat, n bilangan bulat positif, dan x sudut derajat");
      } else if (soal == "Soal 4"){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TugasAsis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TugasAsis dialog = new TugasAsis(new javax.swing.JFrame(), true);
